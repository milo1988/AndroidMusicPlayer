...
import com.huawei.music.service.ServiceBinder;
...
public class MusicUtils {
	...
	public static void updateEqualizerSettings(Context context){
        ...
        SharedPreferences mPreferences = context.getSharedPreferences(APOLLO_PREFERENCES, Context.MODE_WORLD_READABLE| Context.MODE_WORLD_WRITEABLE);
