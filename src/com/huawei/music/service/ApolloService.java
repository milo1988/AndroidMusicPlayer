...
import com.huawei.music.preference.SharedPreferencesCompat;
import com.huawei.music.utils.CallStack;
import com.huawei.music.utils.GetBitmapTask;
import com.huawei.music.utils.ImageUtils;
import com.huawei.music.utils.MusicUtils;
import com.huawei.music.widget.AppWidget41;
...
//        mAppWidgetProvider4x2.notifyChange(this, what);
	...
	private void updateNotification() {
        ...
        //MediaButtonIntentReceiver fileter Intent.ACTION_MEDIA_BUTTON
        ...
        mediaButtonIntent.putExtra(Intent.EXTRA_KEY_EVENT, new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_MEDIA_NEXT));
        ...
        mediaButtonIntent.putExtra(Intent.EXTRA_KEY_EVENT, new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_MEDIA_PREVIOUS));
        mediaPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 4,mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        
        bigViews.setOnClickPendingIntent(R.id.status_bar_prev, mediaPendingIntent);
        
        mediaButtonIntent.putExtra(CMDNOTIF, 3);
        mediaButtonIntent.putExtra(Intent.EXTRA_KEY_EVENT, new KeyEvent(KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_MEDIA_STOP));
        mediaPendingIntent = PendingIntent.getBroadcast(getApplicationContext(), 3, mediaButtonIntent, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        status.bigContentView = bigViews;
        ...
        status.contentIntent = PendingIntent.getActivity(this, 0, new Intent("com.huawei.xdevice.PLAYBACK_VIEWER")
...
//                            : R.drawable.apollo_holo_dark_pause);
    ...
    private synchronized void updateAlbumBitmap() {
    	...
    	//get album bitmap, if ready call bitmapReady 
