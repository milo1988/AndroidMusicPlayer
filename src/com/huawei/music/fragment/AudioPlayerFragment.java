...
package com.huawei.music.fragment;

import java.io.File;
import java.lang.ref.WeakReference;
import java.util.List;

import com.huawei.music.adapter.AlbumArtPagerAdapter;
import com.huawei.music.bean.ImageInfo;
import com.huawei.music.service.ApolloService;
import com.huawei.music.utils.ApolloUtils;
import com.huawei.music.utils.ImageUtils;
import com.huawei.music.utils.MusicUtils;
import com.huawei.music.view.LrcHandle;
import com.huawei.music.view.LrcTextView;
import com.huawei.music.widget.RepeatingImageButton;
...
public class AudioPlayerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mWordView = (LrcTextView) root.findViewById(R.id.lrcText);
       
        
//        final MusicPlayerView mpv = (MusicPlayerView) root.findViewById(R.id.mpv);
...
//        VisualizerUtils.updateVisualizerView(mView);
    ...
    private long refreshNow() {
        ...
        try {
            ...
            String filePath = MusicUtils.mService.getPath();
            ...
            if ((pos >= 0) && (mDuration > 0)) {
                ...
                if (MusicUtils.mService.isPlaying()) {
                    ...
                    mCurrentTime.setTextColor(col == getResources().getColor(R.color.transparent_black) ? getResources().getColor(R.color.holo_blue_dark) : getResources().getColor(R.color.transparent_black));
                    remaining = 500;
                }
                
                String audioFilePath = ImageUtils.getFilePathByUri(Uri.parse(filePath), getActivity());
                String audioLrcPath = audioFilePath.replace(".mp3", ".lrc");
                if(new File(audioLrcPath).exists()){
                	 mWordView.update(pos,audioLrcPath);
                }else{
                	mWordView.setVisibility(View.INVISIBLE);
                }
                mProgress.setProgress((int)(1000 * pos / mDuration));
                Log.i("AudioPlayerFragment", " pos " + pos + " mDuration " + mDuration + " audioFilePath " + audioFilePath   );
            } else {
